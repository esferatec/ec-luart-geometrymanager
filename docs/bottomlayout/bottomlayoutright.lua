...
local win = ui.Window("BottomLayout - Right", 600, 400)

local bottom = gm.GeometryManager():BottomLayout(win, gm.DIRECTION.Right, 20, { 10, 10, 10, 10 }, 50)

local button1 = ui.Button(win, "Button 1", 0, 0, 100, 50)
local button2 = ui.Button(win, "Button 2", 0, 0, 180, 20)
