...
local win = ui.Window("TopLayout - Right", 600, 400)

local top = gm.GeometryManager():TopLayout(win, gm.DIRECTION.Right, 20, {10, 10, 10, 10}, 50)
...
top:add(button3, gm.ALIGNMENT.Bottom)
